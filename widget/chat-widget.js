(function() {
  ...
  const BOTTOM_OFFSET = parseInt(scriptTag.getAttribute('data-bottom-offset')) || 0;
  const H_MARGIN = parseInt(scriptTag.getAttribute('data-horizontal-margin')) || 40;
  const PERSONA = scriptTag.getAttribute('data-persona');
